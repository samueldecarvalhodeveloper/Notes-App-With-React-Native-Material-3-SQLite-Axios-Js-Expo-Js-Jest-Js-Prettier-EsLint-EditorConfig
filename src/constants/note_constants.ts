import NoteDataTransferObject from "../data/remote_data/data_transfer_objects/note_data_transfer_object";
...
export const DELETING_NOTES_QUERY = `DELETE FROM ${NOTE_DATABASE_TABLE_NAME}`;
