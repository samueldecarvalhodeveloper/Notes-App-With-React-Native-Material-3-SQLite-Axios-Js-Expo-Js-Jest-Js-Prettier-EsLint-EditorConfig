...
import NoteEntity from "../../../data/local_data/entities/note_entity";
...
describe("Test Class NoteRepository", () => {
  let noteRepository: NoteRepository;

  test('Test If Method "synchronizeWithNotesFromService" Returns Synchronizes Notes From Service To Notes On Database', async () => {
    ...
    await noteRepository.synchronizeWithNotesFromService(USER_ID);
  ...
  test('Test If Method "getCreatedNote" Returns Created Note On Database And On Service', async () => {
    const noteGatewayMock = {
  ...
  test('Test If Method "getUpdatedNote" Returns Updated Note On Database And On Service', async () => {
    const noteGatewayMock = {
  ...
  test('Test If Method "delete" Deletes Note On Database And On Service', async () => {
    const noteGatewayMock = {
      deleteNote: async () => {},
    } as unknown as NoteGateway;
    const noteDataAccessObjectMock = {
