...
describe("Test Class NoteDataAccessObject", () => {
  ...
  test('Test If Method "createNote" Creates Note On Database', async () => {
    ...
    expect(isNoteCreated).toBeTruthy();
  });
  ...
  test('Test If Method "deleteNotes" Deletes All Notes On Database', async () => {
    let areNoteDeleted = false;
    ...
    await noteDataAccessObject.deleteNotes();

    expect(areNoteDeleted).toBeTruthy();
  });
